...
class BusSeatMapAdapter(private val seatsList: Array<BusLayoutInfo.TotalSeatList.LowerdeckSeatNo>) :
    RecyclerView.Adapter<BusSeatMapAdapter.ViewHolder>() {
    ...
    override fun getItemCount() = seatsList.size
